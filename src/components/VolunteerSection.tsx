  ...
  return (
    <div className="max-w-4xl mx-auto py-12 px-4 sm:px-6">
      ...
      <div className="bg-white border border-neutral-150 rounded-3xl p-8 sm:p-14 space-y-8 shadow-xs relative overflow-hidden">
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-64 h-64 bg-amber-400/5 rounded-full blur-3xl pointer-events-none" />

        <div className="relative text-center space-y-4 max-w-2xl mx-auto">
          <div className="mx-auto w-14 h-14 rounded-full bg-amber-400/10 flex items-center justify-center text-amber-500 mb-4">
        ...
        <div className="max-w-xl mx-auto relative z-10">
          {isSubmitted ? (
            <div className="bg-amber-400/15 border border-amber-300/40 p-6 rounded-2xl text-amber-700 font-semibold text-sm animate-fade-in flex flex-col items-center justify-center text-center gap-3">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-1.5 text-left">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-3 bg-neutral-50 border border-neutral-200 rounded-xl text-neutral-800 placeholder-neutral-400 text-sm focus:outline-hidden focus:ring-2 focus:ring-amber-400 focus:bg-white transition-all font-medium"
                    />
                  </div>
                </div>
              ...
              <div className="space-y-1.5 text-left">
                ...
                <div className="relative">
                  ...
                  <textarea
                    ...
                    rows={4}
                    className="w-full pl-10 pr-4 py-3 bg-neutral-50 border border-neutral-200 rounded-xl text-neutral-800 placeholder-neutral-400 text-sm focus:outline-hidden focus:ring-2 focus:ring-amber-400 focus:bg-white transition-all font-medium resize-none"
                  />
                </div>
              </div>
              ...
              <div className="pt-2 space-y-4">
                <button
                  ...
                  className="w-full py-4 rounded-xl text-base font-bold bg-neutral-900 text-amber-400 hover:bg-neutral-800 hover:text-amber-300 transition-colors flex items-center justify-center gap-2 cursor-pointer shadow-sm"
                >
